...
try:
    ...
    with open(env_file, "a", encoding="utf-8") as env_file:
        ...
        env_file.write("BEEKEEPING_LIST_IN_PROGRESS=626194dbe7010d258db382cd\n")
        env_file.write("COLLECTIVE_LIST_COMPLETED=64b21cde88cacf22ced015fa\n")
        env_file.write("COLLECTIVE_LIST_UNASSIGNED=64b21cde88cacf22ced015f8\n")
        env_file.write("COLLECTIVE_LIST_IN_PROGRESS=64b21cde88cacf22ced015f9\n")
